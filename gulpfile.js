...
const svgSrcPath = "./src/assets/svg/**/*.svg";
...
const svgDistPath = "./dist/assets/svg";
...
// 監視タスク
const watchTask = () => {
  watch(srcPath, series(compileSass, minJs, minImage, svg, reloadBrowserSync));
};
