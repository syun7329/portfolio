...
<head>
  ...
  <script defer src="<?php echo get_template_directory_uri(); ?>/dist/assets/js/fontFamily.js"></script>
  <script defer src="<?php echo get_template_directory_uri(); ?>/dist/assets/js/app.js"></script>
  <script defer src="<?php echo get_template_directory_uri(); ?>/dist/assets/js/swiperSettings.js"></script>
...
<body class="drawer drawer--right" data-tmpdir="<?php echo esc_url(get_template_directory_uri()); ?>/">
  ...
  <header class="header">
    ...
    <div class="header__inner">
      ...
      <a class="header__logoArea" href="<?php echo home_url(); ?>">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="50.137" height="34.101" viewBox="0 0 50.137 34.101">
  ...
  <nav class="drawerNav drawer-nav drawer-close" role="navigation">
    ...
    <ul class="drawerNav__list drawer-menu">
      ...
      <li class="drawerNav__item drawer-menu-item">
        <a class="drawerNav__link" href="<?php echo home_url(); ?>">
          ...
          <img class="drawerNav__arrow" src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common/hamburger_arrow.svg" alt="矢印">
        </a>
      </li>
      ...
      <li class="drawerNav__item drawer-menu-item">
        <a class="drawerNav__link" href="<?php echo home_url("diary"); ?>">
          <span class="drawerNav__text">DIARY</span>
          <img class="drawerNav__arrow" src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common/hamburger_arrow.svg" alt="矢印">
        </a>
      </li>
    ...
    <div class="drawerNav__buttons">
      ...
      <a href="<? echo home_url('contact'); ?>" class="button button--drawerNav c:green bg:white" target="_blank" rel="noopener noreferrer">
        <div class="button__contents">
          <div class="button__text">法人の方は<span class="indentWord">こちら</span></div>
        </div>
      </a>

      <a href="<? echo home_url('contact'); ?>" class="button button--drawerNav c:white bg:green" target="_blank" rel="noopener noreferrer">
        <div class="button__contents">
    ...
    <small class="drawerNav__copyRight">Copyright COOOL All rights reserved.</small>
