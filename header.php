  ...
  <header class="header">
    ...
    <div class="header__inner">
      ...
      <a href="<?php echo home_url() ?>" class="header__logoArea js-header__logoArea">
        <svg class="header__logo header__logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 302 206.07">
    ...
    <ul class="drawerNav__list drawer-menu">
      ...
      <li class="drawerNav__item drawer-menu-item">
        <a class="drawerNav__link" href="<?php echo home_url(); ?>">
          ...
          <img class="drawerNav__arrow" src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/circle-arrow.svg" alt="矢印">
        </a>
      </li>
